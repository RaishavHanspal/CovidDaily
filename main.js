...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 60, vars: 17, consts: [["class", "overlay", 4, "ngIf"], [1, "header"], ["id", "threedots"], ["width", "1em", "height", "1em", "viewBox", "0 0 16 16", "fill", "currentColor", "xmlns", "http://www.w3.org/2000/svg", 1, "bi", "bi-circle-fill", 2, "cursor", "pointer"], ["cx", "8", "cy", "8", "r", "8"], [1, "vertical-center"], [1, "level1"], ["id", "datepicker"], ["matInput", "", "value", "", 3, "matDatepicker", "max", "ngModel", "ngModelChange"], ["matSuffix", "", 3, "for"], ["datepicker", ""], [1, "row"], [1, "column", "left"], [1, "scroll1"], [1, "example-list-section"], ["color", "primary", 3, "ngModel", "ngModelChange", "click"], ["class", "checkbox", 4, "ngFor", "ngForOf"], [1, "column", "right"], [2, "text-align", "center"], [1, "statsFields"], ["appearance", "outline", 3, "floatLabel"], [2, "font-size", "larger"], ["matInput", "", "readonly", "", 1, "textCenter", 2, "font-weight", "bold", "font-size", "25px", 3, "value"], ["matInput", "", "readonly", "", 1, "textCenter", 3, "value"], [1, "textCenter"], [4, "ngIf"], ["class", "textCenter", 4, "ngIf"], [1, "overlay"], [1, "spinner", "textCenter"], ["mode", "indeterminate", "value", "50"], [1, "checkbox"], ["color", "primary", 3, "ngModel", "ngModelChange"], [2, "height", "380px", "margin-top", "-12px", "margin-left", "5px"], [1, "charts"], [3, "title", "type", "data", "options", "width", "height"], ["chart", ""], [2, "font-size", "40px", "font-weight", "100"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
